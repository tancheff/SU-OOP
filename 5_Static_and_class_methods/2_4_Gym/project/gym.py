...
class Gym:
    ...
    def subscription_info(self, subscription_id: int):
        ...
        exercise_plan = next(filter(lambda p: p.trainer_id == trainer.id, self.plans))
        equipment = next(filter(lambda e: e.id == exercise_plan.equipment_id, self.equipment), "Nqma ni6to")
